...
# print(data['A'][1])
data.to_csv("./naver_worry_finally_0906_preprocessing_yes_null.csv",encoding='cp949')

data = pd.read_csv("./naver_worry_finally_0906_preprocessing_yes_null.csv",encoding='cp949')
