...
# with open('./data/naver_worry_health.csv','a',newline='') as outcsv:
...
for page in pages:
    for num in num_per_page:
        ...
        url = f'https://kin.naver.com/qna/expertAnswerList.nhn?dirId=70101&queryTime=2020-08-10%2010%3A56%3A42&page={page}'
        ...
        while answer_num <= 20:
            ...
            if '의사 님 답변' in answer_writer and answer_writer != '비공개 답변':
        ...
        try:
            with open('./data/naver_worry_health.csv','a',newline='',encoding='cp949') as outcsv_1:
